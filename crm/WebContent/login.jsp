...
<BODY>
<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/user_login.action" target="_parent" method=post>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD><INPUT id=btn 
                  ...
                  <input type="button" value="注册" onclick="registerUI()" style="background-image: 'images/regist_button.gif'"/>
