...
<BODY>
	<s:form id="customerForm" name="customerForm" action="linkMan_findAll.action" method="post" theme="simple">
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
														<s:textfield name="lkm_name" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"/>
													</TD>
													<TD>性别：</TD>
													<TD>
											...
											<TBODY>
												...
												<TR
													...
													<TD>
														...
														<s:elseif test='lkm_gender == "2"'>女</s:elseif>
													</TD>
