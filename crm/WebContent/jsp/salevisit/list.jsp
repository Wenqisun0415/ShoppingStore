...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#visit_end_time').datepick({dateFormat: 'dd/mm/yy'}); 
	}); 
</script>
...
<BODY>
	<s:form id="saleVisitForm" name="saleVisitForm" action="saleVisit_findAll.action" method="post" theme="simple">
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：从</TD>
													<TD>
														<input id="visit_time" name="visit_time" readonly value="<s:date name="visit_time" format="dd/MM/yyyy"/>"/>
														
													</TD>
													<TD>到</TD>
													<TD>
														<input id="visit_end_time" name="visit_end_time" readonly value="<s:date name="visit_end_time" format="dd/MM/yyyy"/>"/>
													</TD>
