...
<html>
	...
	<body>
		...
		<div class="container">
						...
						<tbody>
							...
							<c:forEach items="${order.orderItems }" var="item">
								<tr class="active">
									...
									<td width="30%">
										<a target="_blank" href="${pageContext.request.contextPath }/ProductServlet?method=findProductByPid&pid=${item.product.pid }">${item.product.pname }</a>
									</td>
									<td width="20%">
			...
			<div>
			<form id="orderForm" class="form-horizontal" style="margin-top:5px;margin-left:150px;" method="post" action="OrderServlet?method=payOrder">
				<hr/>
