	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${hotPro }" var="h">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><font color="#E4393C" style="font-size:16px">&yen;${h.store_price }</font></p>
					</div>
				</c:forEach>
			...
			<div class="container-fluid">
				...
				<c:forEach items="${newPro }" var="n">
					<div class="col-md-2 yes-right-border" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/ProductServlet?method=findProductByPid&pid=${n.pid }">
							<img src="${pageContext.request.contextPath }/${n.pimage }" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath }/ProductServlet?method=findProductByPid&pid=${n.pid }" style='color:#666'>${n.pname }</a></p>
						<p><font color="#E4393C" style="font-size:16px">&yen;${n.store_price }</font></p>
					</div>
				</c:forEach>
