		...
		<div class="col-md-3" style="padding-top: 20px">
			<ol class="list-inline">
				...
				<c:if test="${not empty UserBean }">
					<li>${UserBean.name }，欢迎您</li>
					<li><a
						href="${pageContext.request.contextPath}/UserServlet?method=logout">退出</a></li>
				</c:if>

				<li><a href="${pageContext.request.contextPath}/CartServlet?method=showCart">购物车</a></li>
				<li><a
					href="${pageContext.request.contextPath}/OrderServlet?method=showOrders&page=1">我的订单</a></li>
			</ol>
		</div>
	</div>
	<!--
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav" id="cat">
