			...
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${product.store_price }元/份</strong> 市场价： <del>￥${product.market_price }元/份</del>
						</div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form action="${pageContext.request.contextPath}/CartServlet?method=addItem" method="post">
